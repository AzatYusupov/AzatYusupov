...
public class MultipartRequest extends Request<String>  {
    ...
    public MultipartRequest(Context context, String url, final Map<String, String> params, File imageFile, String filename, String fileFieldName, ErrorListener errorListener, Listener<String> listener ){
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
        return Headers.headerMap(context);
    }
